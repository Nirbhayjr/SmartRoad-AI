                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                        <div className="bg-gray-800 rounded-lg p-8 border-2 border-gray-700 hover:border-blue-500 transition">
                           ...
                           {/* Drag Drop Area */}
<div
    onClick={() => fileInputRef.current?.click()} // Pura box click karne par file panel khulega
...
>
    <input
        ...
        className="hidden"
        disabled={loading}
        ref={fileInputRef} // Ye sabse important hai
    />

    {/* Label ki jagah ab hum normal Div use karenge kyunki onClick box par hai */}
    <div className="cursor-pointer block">
        ...
        <p className="text-sm text-gray-400">
            or click anywhere in this box to select
                   ...
                   {/* Results Section */}
                    <div className="space-y-6">
                        {/* RESULT & STATISTICS (Shows only when AI finishes) */}
                        {result && !loading && (
                        ...
                        {/* EMPTY STATE (Shows when no image is uploaded yet) */}
                        {!result && !loading && (
                    ...
                    </div> {/* Results Section ka div close */}
                
                {/* 👇 YE 5 LINES MISSING THI 👇 */}
                </div>
            </div>
        </div>
    )
